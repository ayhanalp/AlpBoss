...
if("FALSE" STREQUAL "TRUE")
  set(dji_sdk_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/Onboard-SDK-ROS/dji_sdk)
  set(dji_sdk_DEVEL_PREFIX /home/ubuntu/catkin_ws/src/Onboard-SDK-ROS/dji_sdk/devel)
  set(dji_sdk_INSTALL_PREFIX "")
  set(dji_sdk_PREFIX ${dji_sdk_DEVEL_PREFIX})
else()
  set(dji_sdk_SOURCE_PREFIX "")
  set(dji_sdk_DEVEL_PREFIX "")
  set(dji_sdk_INSTALL_PREFIX /usr/local)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dji_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'Norman Li <norman.li@dji.com>, Arjun Menon <arjun.menon@dji.com>' to fix it.")
    endif()
