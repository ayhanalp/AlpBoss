...
float advAttitude_chatter_enable = 0;
...
void velocitychatterCallback(const geometry_msgs::Twist::ConstPtr& msg)
{
  ...
  velocity_chatter_enable = msg->angular.z;
...
void advAttitudechatterCallback(const geometry_msgs::Twist::ConstPtr& msg)
{
  ...
  advAttitude_chatter_enable = msg->angular.z;
...
int main(int argc, char **argv)
{
   ...
   */
   /* Basic subscribers */
  ros::Subscriber sub = n.subscribe<geometry_msgs::Twist>("chatter_velocity", 10, velocitychatterCallback);
  ros::Subscriber sub2 = n.subscribe<geometry_msgs::Twist>("chatter_attitude", 10, attitudechatterCallback);
  ros::Subscriber sub3 = n.subscribe<geometry_msgs::Twist>("chatter_advAttitude", 10, advAttitudechatterCallback);
  ...
  while (ros::ok())
  {
    ...
    else if (attitude_chatter_enable == 1) {
    ...
    else if (advAttitude_chatter_enable == 1) {
