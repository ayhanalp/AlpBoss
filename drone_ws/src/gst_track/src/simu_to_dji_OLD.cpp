...
int main(int argc, char **argv)
{
   ...
   */
   /* Basic subscribers */
  ros::Subscriber sub = n.subscribe<geometry_msgs::Twist>("chattertest", 10, chatterCallback);
  ros::Subscriber sub2 = n.subscribe<geometry_msgs::Twist>("chatter2", 10, chatter2Callback);
  ros::Subscriber sub3 = n.subscribe<geometry_msgs::Twist>("chatter3test", 10, chatter3Callback);
